...
public class StringDynamicParameter extends DynamicParameter<String> {
    public StringDynamicParameter(String displayName, PREFIX prefix, String name, String defaultValue) {
        super(displayName, prefix, name, parseStringToValue(defaultValue));
    }

    public static String parseStringToValue(String val) {
        if (val == null) {
