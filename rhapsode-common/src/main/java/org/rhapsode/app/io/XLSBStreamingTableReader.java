...
public class XLSBStreamingTableReader extends AbstractWorkbookTableReader {
    ...
    public void parse() throws TableReaderException {
        XSSFBSharedStringsTable sharedStringsTable = null;
        ...
        try {
            ...
            throw new TableReaderException("Bad styles table");
        }
        setSheetInputStream(worksheetName, xssfReader);

        try {
            DataFormatter formatter = new DataFormatter();
            XSSFBSheetHandler xssfbSheetHandler = new
                    XSSFBSheetHandler(sheetInputStream,
