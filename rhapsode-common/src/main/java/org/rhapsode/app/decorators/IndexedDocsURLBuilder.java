...
public class IndexedDocsURLBuilder extends BaseURLBuilder {

    public static String build(String fileId, int offset, BaseSearchRequest request) {
        StringBuilder sb = new StringBuilder();
        sb.append("/rhapsode/view_docs?");

        tryToAddQueryParameters(C.FILE_KEY, fileId, sb);
        tryToAddQueryParameters(C.ATTACHMENT_OFFSET, Integer.toString(offset), sb);
        ...
        sb.append("#").append(H.JUMP_TO_TARGET);
        return sb.toString();
    }
}
