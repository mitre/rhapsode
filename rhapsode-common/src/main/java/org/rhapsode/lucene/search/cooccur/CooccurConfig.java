...
public class CooccurConfig extends ConcordanceSearchConfig {

    @Override
    public DocMetadataExtractor getDocMetadataExtractor() {
        //TODO: fix
        return new SimpleDocMetadataExtractor("_id");
    }

    public static class Builder {
        public static CooccurConfig build(JsonElement concordance_search) {

            //TODO: fill in!!!
            return new CooccurConfig();
        }
    }
